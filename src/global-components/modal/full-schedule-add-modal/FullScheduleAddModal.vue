        ...
        <div class="date-time-box">
          ...
          <div class="input-col time-col divider-top">
            <div class="time-range">
              ...
              <TimePicker v-model="form.startTime" class="tabular-nums" />
              <span class="range-dash">-</span>
              <TimePicker v-model="form.endTime" class="tabular-nums" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="modal-section" style="position: relative; z-index: 85">
            ...
            <div class="meta-grid">
              <div v-if="form.type === 'event'" class="input-col">
                ...
                <SelectList v-model="form.goalId" :options="goalOptions" />
              </div>
